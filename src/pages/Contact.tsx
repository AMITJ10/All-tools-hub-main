...
const Contact = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast({
      title: "Message Sent!",
      description: "Thank you for contacting us. We appreciate your feedback and will get back to you as soon as possible.",
    });
        ...
        <div className="space-y-12">
          <div className="text-center space-y-4">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              We value your feedback and are here to help. Whether you have a question, a suggestion for a new calculator, or a bug to report, please don't hesitate to reach out. Your input helps us make CalculatorApps better for everyone.
            </p>
          </div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea
                        ...
                        placeholder="Please describe your inquiry in detail. If reporting a bug, please include the steps to reproduce it."
                        required
                        rows={6}
                        className="border-input-border focus:border-input-focus"
                      />
            ...
            <div className="space-y-6">
              <Card className="glass border-2">
                ...
                <CardContent className="space-y-4 text-muted-foreground">
                    <p className="text-sm">We are a small team dedicated to providing the best possible experience. We read every message and aim to respond within 24-48 business hours.</p>
