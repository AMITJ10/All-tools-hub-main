      ...
      <main className="container mx-auto px-4 py-12 max-w-4xl">
        <div className="space-y-12">
          <div className="text-center space-y-4">
            ...
            <h1 className="text-4xl font-bold text-foreground">Welcome to OneCalc</h1>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">
                In a world full of complex information, our mission is to provide simple, accurate, and powerful tools that help you make informed decisions. Whether you're planning your finances, checking your health metrics, or converting units for a project, OneCalc is designed to give you clear answers instantly. We believe that everyone should have access to high-quality calculation tools without any cost.
              </p>
            </div>
